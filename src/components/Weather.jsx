        ...
        <div className="weather-cards">
            {data.slice(0, 3).map((card, idx) => (
                <div key={idx} className="weather-card">
                    <div className="weather-card-location" style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
                    ...
                    <img className="weather-card-icon" src={`https://openweathermap.org/img/wn/${card.weather.icon}@2x.png`} alt="weather-icon" style={{ width: '100px', height: '100px', margin: '12px 0' }} />
                    ...
                    <div className="weather-cards-footer" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', marginTop: '16px' }}>
                        <img className="weather-cards-footer-img-refresh" src={refreshImage} alt="Refresh" />
                        <img className="weather-cards-footer-img-heart" src={heartImage} alt="Favorite" />
                        <button className="weather-cards-footer-button">See more</button>
                        <img className="weather-cards-footer-img-delete" src={deleteImage} alt="Delete" style={{ width: '28px', cursor: 'pointer' }} />
                    </div>
                </div>
            ))}
        </div>
